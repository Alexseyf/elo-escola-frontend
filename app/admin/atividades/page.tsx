    ...
    <RouteGuard allowedRoles={['ADMIN']}>
      <div className="min-h-screen bg-gray-50/50 p-4 md:p-8">
        <div className="max-w-6xl mx-auto space-y-6">
          {/* Header */}
          <div>
            <h1 className="text-2xl font-semibold text-gray-900">Atividades Pedagógicas</h1>
            <p className="text-gray-500 mt-1">Gerencie as atividades cadastradas no sistema</p>
          </div>
