...
import { Search, ChevronLeft, ChevronRight, User, Shield, GraduationCap, Users, Plus, Edit, Eye } from "lucide-react"
                                                        ...
                                                        <td className="px-6 py-4 whitespace-nowrap text-right text-sm">
                                                            <div className="flex justify-end items-center gap-2">
                                                                <Button
                                                                    variant="outline"
                                                                    size="sm"
                                                                    className="text-primary border-primary/20 hover:bg-primary/10 hover:border-primary/50 transition-colors gap-2"
