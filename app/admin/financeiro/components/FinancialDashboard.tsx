                    ...
                    <CardContent className="p-0">
                        ...
                        <div className="md:hidden divide-y">
                            {balanco.turmas.map((t) => (
                                <div key={t.turmaId} className="px-4 py-4 space-y-3">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="space-y-0.5">
                                            <span className="text-[10px] uppercase font-bold text-muted-foreground tracking-wider">Receita</span>
                                            <p className="text-sm font-semibold text-emerald-600">
                                                {new Intl.NumberFormat('pt-BR', { style: 'currency', currency: 'BRL' }).format(t.receita)}
                                            </p>
                                        </div>
                                        <div className="space-y-0.5">
                                            <span className="text-[10px] uppercase font-bold text-muted-foreground tracking-wider">Saldo Final</span>
                                            <p className={`text-sm font-bold ${t.saldo >= 0 ? 'text-blue-600' : 'text-rose-600'}`}>
                                ...
                                <tbody className="divide-y">
                                    {balanco.turmas.map((t) => (
                                        <tr key={t.turmaId} className="hover:bg-muted/30 transition-colors">
                                            <td className="px-6 py-4 font-medium text-slate-900">{t.nome}</td>
                                            <td className="px-6 py-4">{t.quantidadeAlunos}</td>
