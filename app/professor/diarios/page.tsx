                      ...
                      turma.alunos.map(aluno => {
                        ...
                        return (
                          <Link
                            ...
                            key={aluno.id}
                            className={`group relative bg-white p-4 rounded-lg border transition-all hover:shadow-md hover:border-blue-200 ${temDiario ? 'border-green-200 bg-green-50/30' : 'border-gray-200'
                              }`}
                          >
