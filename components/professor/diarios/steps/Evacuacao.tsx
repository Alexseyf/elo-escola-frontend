...
const OPTIONS = [
  { id: 'NORMAL', label: 'Normal', color: 'border-blue-200 bg-blue-50/50 text-blue-600' },
  { id: 'LIQUIDA', label: 'Líquida', color: 'border-amber-200 bg-amber-50/50 text-amber-600' },
  { id: 'DURA', label: 'Dura', color: 'border-rose-200 bg-rose-50/50 text-rose-600' },
  { id: 'NAO_EVACUOU', label: 'Não evacuou', color: 'border-slate-200 bg-slate-50/50 text-slate-500' },
];
